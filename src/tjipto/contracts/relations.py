...
RELATIONS: dict[str, RelationDescriptor] = {
    ...
    "INSERTS": RelationDescriptor("INSERTED_BY", _LEGAL_UNIT, _LEGAL_UNIT, True, True, True, True),
    "INSERTED_BY": RelationDescriptor("INSERTS", _LEGAL_UNIT, _LEGAL_UNIT, True, True, True, True),
