...
def load_compatibility_seed(stage_dir: Path) -> dict:
    ...
    return {
        ...
        "pages": read_jsonl(stage_dir / "pages.jsonl"),
        ...
        "document_metadata": read_jsonl(stage_dir / "document_metadata.jsonl"),
        "metadata_grounding": read_jsonl(stage_dir / "metadata_grounding.jsonl"),
        "metadata_grounding_registry": read_jsonl(stage_dir / "metadata_grounding_registry.jsonl"),
        ...
        "excluded_records": read_jsonl(stage_dir / "excluded_records.jsonl"),
        "source_conflicts": read_jsonl(stage_dir / "source_conflicts.jsonl"),
        "validation_report": read_json(stage_dir / "validation_report.json"),
        "source_documents": read_jsonl(stage_dir / "source_documents.jsonl"),
    }
