...
_CI_GATES = frozenset(
    {
        "compileall", "unittest", "pytest", "pytest_run_1", "pytest_run_2", "retrieval_evaluation", "source_text_evaluation", "meaningful_support_evaluation", "support_reachability_evaluation", "artifact_validate", "artifact_rebuild", "ruff", "mypy",
