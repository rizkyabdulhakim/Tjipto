...
BACKEND_GATES = frozenset((
    "toolchain", "compileall", "unittest", "pytest_run_1", "retrieval_evaluation", "research_retrieval_evaluation", "answer_evaluation",
...
BACKEND_EVIDENCE = frozenset((
    ...
    "retrieval-evaluation.json", "retrieval-evaluation-command.json", "research-retrieval.json", "research-retrieval-command.json", "answer-evaluation.json", "answer-evaluation-command.json",
