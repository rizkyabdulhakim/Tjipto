...
BACKEND_GATES = frozenset((
    "toolchain", "compileall", "unittest", "pytest_run_1", "retrieval_evaluation", "research_retrieval_evaluation_v0", "answer_evaluation",
...
BACKEND_EVIDENCE = frozenset((
    ...
    "retrieval-evaluation.json", "retrieval-evaluation-command.json", "research-retrieval-v0.json", "research-retrieval-v0-command.json", "answer-evaluation.json", "answer-evaluation-command.json",
