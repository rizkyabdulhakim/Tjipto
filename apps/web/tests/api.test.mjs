...
const legalSupport = {
  ...
  layout_lines: [{ text: "Pasal 16", line_order: 0, paragraph_id: "0", alignment: "center", indent: 0, canonical_start: 0, canonical_end: 8 }],
  copy_text: "Pasal 16\n\nPresiden membentuk dewan.",
