...
class AnswerEvaluationGateTest(unittest.TestCase):
    def test_cases_cover_answer_boundaries(self) -> None:
        ...
        self.assertLessEqual(
            {"exact_reference", "paraphrase", "concept_synonym", "person_institution", "date_metadata", "historical", "relation", "multi_support", "ambiguity", "ambiguity_legal_target", "ambiguity_relation_operation", "ambiguity_lexical_target", "typo_noise", "out_of_corpus", "source_annotation", "source_discrepancy", "proposition", "proposition_contradiction"},
